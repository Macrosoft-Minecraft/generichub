...
const TUTORIAL = {
    ...
    tutorial: {
        ...
        "mensagem": {
            "sucesso": true,
            "mensagem": "Bem vindo ao hub websocket da Macrosoft v1",
            "eventos": ["entrar-sala", "criar-sala", "bem-vindo", "não-autorizado", "adicionar-evento", "remover-evento", "remover-sala", "listar-salas"],
            "tutorial": {
                "ping": {
        ...
        "eventos": ["entrar-sala", "criar-sala", "ping", "pong", "bem-vindo", "não-autorizado", "adicionar-evento", "remover-evento", "remover-sala", "listar-salas"]
    }
  }
